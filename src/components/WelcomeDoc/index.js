...
export const WelcomeDoc = () => {
    return (
        <div className='vh-100 '>
            ...
            <div className='text-center overflow-hidden' style={{ width: "20rem", height: "auto" }}>
                <img src="https://res.cloudinary.com/tanvo/image/upload/v1673988557/medlangfanatic/documentationPage-welcom_ja6fbo.png" alt="welcome"
